...
newTalent{
	name = "Channel Staff", short_name = "BOMBARDIER_CHANNEL_STAFF",
	type = {"spell/bombardier-staff-combat", 1},
	require = spells_req1,
	points = 5,
	mana = 5,
	tactical = { ATTACK = 1 },
...
newTalent{
	name = "Staff Mastery", short_name = "BOMBARDIER_STAFF_MASTERY",
	type = {"spell/bombardier-staff-combat", 2},
	mode = "passive",
	require = spells_req2,
	points = 5,
...
newTalent{
	name = "Defensive Posture", short_name = "BOMBARDIER_DEFENSIVE_POSTURE",
	type = {"spell/bombardier-staff-combat", 3},
	require = spells_req3,
	mode = "sustained",
	points = 5,
	sustain_mana = 20,
	cooldown = 30,
	tactical = { BUFF = 2 },
	getDefense = function(self, t) return self:combatTalentSpellDamage(t, 15, 25) end,
	on_pre_use = function(self, t, silent) if not self:hasStaffWeapon() then if not silent then game.logPlayer(self, "You need a staff to use this spell.") end return false end return true end,
...
newTalent{
	name = "Blunt Thrust", short_name = "BOMBARDIER_BLUNT_THRUST",
	type = {"spell/bombardier-staff-combat",4},
	require = spells_req4,
	points = 5,
	mana = 12,
	cooldown = 12,
